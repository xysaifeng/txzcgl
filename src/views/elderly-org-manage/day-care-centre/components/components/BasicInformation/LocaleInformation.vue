  ...
  <div>
    ...
    <el-form ref="formRef" :model="form" :rules="this.isEditForm?rulesForm:null" label-width="150px">
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          ...
          <el-form-item class="form-item-custom" prop="name_orgName">
            <el-input v-if="this.isEditForm" v-model="form.name_orgName" placeholder="请输入" clearable class="long-form-item" />
            <span v-else>{{form.name_orgName}}</span>
          </el-form-item>
          <el-form-item class="form-item-custom" prop="name_houzhui">
            <el-select v-if="this.isEditForm" v-model="form.name_houzhui" placeholder="请选择" clearable class="short-form-item" >
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          ...
          <el-form-item class="form-item-custom" prop="address_cunlujie">
            <el-input v-if="this.isEditForm" v-model="form.address_cunlujie" placeholder="请输入" clearable class="long-form-item" />
            <span v-else>{{form.address_cunlujie}}</span>
          </el-form-item>
          <el-form-item class="form-item-custom" prop="address_cunlujie_houzhui">
            <el-select v-if="this.isEditForm" v-model="form.address_cunlujie_houzhui" placeholder="请选择" clearable class="short-form-item" @change="address_cunlujie_houzhui">
              <el-option
          ...
          <el-form-item class="form-item-custom" prop="address_nong">
            <el-input v-if="this.isEditForm" v-model="form.address_nong" placeholder="请输入" clearable class="long-form-item" />
            <span v-else>{{form.address_nong}}</span>
          </el-form-item>
          <el-form-item class="form-item-custom" prop="address_nong_houzhui">
            <el-select v-if="this.isEditForm" v-model="form.address_nong_houzhui" placeholder="请选择" clearable class="short-form-item" @change="address_nong_houzhui">
              <el-option
          ...
          <el-form-item class="form-item-custom" prop="address_address">
            <el-input v-if="this.isEditForm" v-model="form.address_address" placeholder="请输入" clearable class="long-form-item" />
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="public_enquiry_telephone">
            <el-input v-if="this.isEditForm" v-model="form.public_enquiry_telephone" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="building_area">
                <el-input v-if="this.isEditForm" v-model="form.building_area" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="individual_area">
                <el-input v-if="this.isEditForm" v-model="form.individual_area" placeholder="请输入" clearable class="long-form-item" />
                    ...
                    <div v-if="form.functional_area.checked.includes('0')" class="form-item-panel-custom" style="">
                      ...
                      <div class="form-item-wrap-custom">
                        <el-form-item class="form-item-custom" prop="functional_area.building_area[0]">
                          <el-input v-model="form.functional_area.building_area[0]" placeholder="请输入" clearable class="long-form-item" />
                          <span style="margin-right:5px;">平方/米</span>
                    ...
                    <div v-if="form.functional_area.checked.includes('1')" class="form-item-panel-custom" style="">
                      ...
                      <div class="form-item-wrap-custom">
                        <el-form-item class="form-item-custom" prop="functional_area.building_area[1]">
                          <el-input v-model="form.functional_area.building_area[1]" placeholder="请输入" clearable class="long-form-item" />
                          <span style="margin-right:5px;">平方/米</span>
                    ...
                    <div v-if="form.functional_area.checked.includes('2')" class="form-item-panel-custom" style="">
                      ...
                      <div class="form-item-wrap-custom">
                        <el-form-item class="form-item-custom" prop="functional_area.building_area[2]">
                          <el-input v-model="form.functional_area.building_area[2]" placeholder="请输入" clearable class="long-form-item" />
                          <span style="margin-right:5px;">平方/米</span>
                    ...
                    <div v-if="form.functional_area.checked.includes('3')" class="form-item-panel-custom" style="">
                      ...
                      <div class="form-item-wrap-custom">
                        <el-form-item class="form-item-custom" prop="functional_area.building_area[3]">
                          <el-input v-model="form.functional_area.building_area[3]" placeholder="请输入" clearable class="long-form-item" />
                          <span style="margin-right:5px;">平方/米</span>
                      ...
                      <div v-if="form.which_institutions_adress.checked.includes('0')" class="form-item-panel-custom" style="">
                        ...
                        <div class="form-item-wrap-custom">
                          <el-form-item class="form-item-custom" prop="which_institutions_adress.building_area[0]">
                            <el-input v-model="form.which_institutions_adress.building_area[0]" placeholder="请输入" clearable class="long-form-item" />
                            <span style="margin-right:5px;">平方/米</span>
                      ...
                      <div v-if="form.which_institutions_adress.checked.includes('1')" class="form-item-panel-custom" style="">
                        ...
                        <div class="form-item-wrap-custom">
                          <el-form-item class="form-item-custom" prop="which_institutions_adress.building_area[1]">
                            <el-input v-model="form.which_institutions_adress.building_area[1]" placeholder="请输入" clearable class="long-form-item" />
                            <span style="margin-right:5px;">平方/米</span>
                      ...
                      <div v-if="form.which_institutions_adress.checked.includes('2')" class="form-item-panel-custom" style="">
                        ...
                        <div class="form-item-wrap-custom">
                          <el-form-item class="form-item-custom" prop="which_institutions_adress.building_area[2]">
                            <el-input v-model="form.which_institutions_adress.building_area[2]" placeholder="请输入" clearable class="long-form-item" />
                            <span style="margin-right:5px;">平方/米</span>
                      ...
                      <div v-if="form.which_institutions_adress.checked.includes('3')" class="form-item-panel-custom" style="">
                        ...
                        <div class="form-item-wrap-custom">
                          <el-form-item class="form-item-custom" prop="which_institutions_adress.building_area[3]">
                            <el-input v-model="form.which_institutions_adress.building_area[3]" placeholder="请输入" clearable class="long-form-item" />
                            <span style="margin-right:5px;">平方/米</span>
                      ...
                      <div v-if="form.which_institutions_adress.checked.includes('4')" class="form-item-panel-custom" style="">
                        ...
                        <div class="form-item-wrap-custom">
                          <el-form-item class="form-item-custom" prop="which_institutions_adress.building_area[4]">
                            <el-input v-model="form.which_institutions_adress.building_area[4]" placeholder="请输入" clearable class="long-form-item" />
                            <span style="margin-right:5px;">平方/米</span>
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="floor_information">
            <el-select v-if="this.isEditForm" v-model="form.floor_information" placeholder="请选择" clearable class="long-form-item">
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="device_configuration">
            <el-select v-if="this.isEditForm" v-model="form.device_configuration" placeholder="请选择" clearable class="long-form-item">
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="nature_service_place" style="margin-right:95px;">
          ...
          <span v-if="form.nature_service_place === '1'" style="padding-right:20px;height:36px;line-height:36px;">租赁场所是否归政府所有：</span>
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="service_site_certificate_status">
            <el-select v-if="this.isEditForm" v-model="form.service_site_certificate_status" placeholder="请选择" clearable class="long-form-item">
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="pass_fire_control_inspection_record">
            <el-select v-if="this.isEditForm" v-model="form.pass_fire_control_inspection_record" placeholder="请选择" clearable class="long-form-item">
              <el-option label="是" value="1" />
              <el-option label="否" value="0" />
            </el-select>
...
export default {
  ...
  methods: {
    ...
    handelChange_set_style() {
      ...
      this.$nextTick(() => {
        this.$refs['formRef'].clearValidate('which_institutions_adress.checked')
      })
    },
    ...
    handelChange_nature_service_place() {
      ...
      this.$nextTick(() => {
        this.$refs['formRef'].clearValidate('nature_service_place_ziyou')
        this.$refs['formRef'].clearValidate('nature_service_place_zulin')
      })
    },
    // 回显所有子组件的form字段
