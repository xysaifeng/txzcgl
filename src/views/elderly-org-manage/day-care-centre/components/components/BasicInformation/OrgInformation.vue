...
<template>
  <div>
    ...
    <el-form ref="formRef" :model="form" :rules="this.isEditForm?rulesForm:null" label-width="150px">
      ...
      <div v-if="this.form.is_legally_registered === '1'" class="hidden-form-wrap-custom" style="margin-left: 260px;margin-right: 30px;">
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_legally_registered_yes.contact_number">
                <el-input v-if="this.isEditForm" v-model="form.is_legally_registered_yes.contact_number" placeholder="请输入" clearable class="long-form-item" />
        ...
        <div class="form-item-panel-custom">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="is_legally_registered_yes.operating_brands">
              <el-input v-if="this.isEditForm" v-model="form.is_legally_registered_yes.operating_brands" placeholder="请输入" clearable class="long-form-item" />
      ...
      <div v-if="this.form.is_entrusted_operation === '1'" class="hidden-form-wrap-custom" style="margin-left: 260px;margin-right: 30px;">
        ...
        <div class="form-item-panel-custom">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.unified_social_credit_code">
              <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.unified_social_credit_code" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.legal_representative">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.legal_representative" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.legal_representative_idCard">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.legal_representative_idCard" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.contacts">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.contacts" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.contact_number">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.contact_number" placeholder="请输入" clearable class="long-form-item" />
        ...
        <div class="form-item-panel-custom">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.operating_brands">
              <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.operating_brands" placeholder="请输入" clearable class="long-form-item" />
        ...
        <div class="form-item-panel-custom">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.org_name">
              <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.org_name" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.legal_nature">
                <el-select v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.legal_nature" placeholder="请选择" clearable class="long-form-item" @change="handelChange_is_entrusted_operation_yes_legal_nature">
                  <el-option label="事业单位" value="0" />
                  <el-option label="社会服务组织" value="1" />
                  <el-option label="企业" value="2" />
                </el-select>
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.licence_issuing_authority">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.licence_issuing_authority" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.validity_certificate">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.validity_certificate" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom" v-if="form.is_entrusted_operation_yes.legal_nature !== '2'">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.sponsor">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.sponsor" placeholder="请输入" clearable class="long-form-item" />
          ...
          <div class="form-item-panel-custom">
            ...
            <div class="form-item-wrap-custom">
              <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.initial_fund">
                <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.initial_fund" placeholder="请输入" clearable class="long-form-item" />
        ...
        <div class="form-item-panel-custom">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.business_scope">
              <el-input v-if="this.isEditForm" type="textarea" v-model="form.is_entrusted_operation_yes.business_scope" placeholder="请输入" clearable class="long-form-item textarea-custom" :rows="5"/>
        ...
        <div class="form-item-panel-custom">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="is_entrusted_operation_yes.entrusting_party">
              <el-input v-if="this.isEditForm" v-model="form.is_entrusted_operation_yes.entrusting_party" placeholder="请输入" clearable class="long-form-item" />
