      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="day_care_seat">
            <el-input v-if="this.isEditForm" v-model="form.day_care_seat" placeholder="请输入托位" clearable class="long-form-item" />
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="service_contract_number">
            <el-input v-if="this.isEditForm" v-model="form.service_contract_number" placeholder="请输入签约服务人数" clearable class="long-form-item" />
      ...
      <div class="form-item-panel-custom">
        ...
        <div class="form-item-wrap-custom">
          <el-form-item class="form-item-custom" prop="average_service_volume">
            <el-input v-if="this.isEditForm" v-model="form.average_service_volume" placeholder="请输入日均服务量" clearable class="long-form-item" />
          ...
          <el-form-item class="form-item-custom" prop="service_object.checked" style="display:block;width:100%;">
            <el-checkbox-group v-model="form.service_object.checked" @change="handelChange_service_object">
              ...
              <div class="checkbox-group-block-custom">
                ...
                <div v-if="form.service_object.checked.includes('1')" class="form-item-panel-custom" style="width: 100%;">
              ...
              <div class="checkbox-group-block-custom">
                ...
                <div v-if="form.service_object.checked.includes('2')" class="form-item-panel-custom" style="width: 100%;">
                  <div class="form-item-title-custom">请选择(多选)：</div>
                  <div class="form-item-wrap-custom">
        ...
        <div class="form-item-panel-custom" style="width:50%;">
          ...
          <div class="form-item-wrap-custom">
            <el-form-item class="form-item-custom" prop="service_range">
              <el-select v-if="this.isEditForm" v-model="form.service_range" placeholder="请选择服务范围" clearable class="long-form-item">
