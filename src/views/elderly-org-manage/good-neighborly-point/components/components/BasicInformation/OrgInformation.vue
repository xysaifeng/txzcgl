    ...
    <el-form ref="formRef" :model="form" :rules="this.isEditForm?rulesForm:null" label-width="150px">
      ...
      <div class="form-item-panel-custom">
              ...
              <div class="form-item-wrap-custom">
                <el-form-item class="form-item-custom" prop="name_run_model">
                        <el-select v-if="this.isEditForm" v-model="form.name_run_model" placeholder="请选择运营模式" clearable class="long-form-item">
                          <el-option label="请选择(默认项)" value="0" />
                          <el-option label="召集人自行运营管理" value="1" />
                          <el-option label="由街镇，居村自行运营管理" value="2" />
                          <el-option label="委托第三方运营" value="3" />
                        </el-select>
                        <span v-else>{{form.name_run_model}}</span>
                </el-form-item>
              </div>
      </div>
      <!-- 运营模式 end -->
      ...
      <div v-if="this.form.name_run_model === '3'" class="hidden-form-wrap-custom" style="margin-bottom:15px;">
