...
export default {
  ...
  methods: {
    ...
    echoAllChildrenForm(allForm){
      ...
      this.$refs.serviceInformation.echoAllChildrenForm(allForm)
    },
    // 获取所有子组件的form字段
    getAllChildrenForm(){
      let form1 = this.$refs.serviceAbility.getAllChildrenForm()
      let form2 = this.$refs.serviceInformation.getAllChildrenForm()
      return {...form1,...form2}
    },
    // 子组件校验，传递到父组件
